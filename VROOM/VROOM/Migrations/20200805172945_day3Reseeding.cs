...
{
    public partial class day3Reseeding : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2020, 7, 26, 10, 29, 44, 661, DateTimeKind.Local).AddTicks(6659), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 2, 4, new DateTime(2020, 8, 3, 10, 29, 44, 666, DateTimeKind.Local).AddTicks(2258), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 3, 4, new DateTime(2020, 7, 21, 10, 29, 44, 666, DateTimeKind.Local).AddTicks(2267), new DateTime(2020, 7, 27, 10, 29, 44, 666, DateTimeKind.Local).AddTicks(2273), 2 },
                    { 1, 6, new DateTime(2020, 8, 4, 10, 29, 44, 666, DateTimeKind.Local).AddTicks(2143), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 }
                });
